...
const model = {
    ...
    async fetchNews(query, page) {
        try {
            const url = `https://newsapi.org/v2/top-headlines?country=us&q=${query}&from=2024-04-24&pageSize=20&page=${page}&sortBy=popularity&apiKey= 83ed4c33713144889c2d63f4ee417f59`;
